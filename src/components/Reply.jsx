...
function Reply(props) {
  ...
  const editReplyHandler = (e) => {
    ...
    context.editReply(input, props.commentId, props.id);
    setEditing(false);
  };

  let score;

  const editReplyScoreHandler = (e) => {
    score = props.score;
    if (e.target.className === "increase") {
      score = parseInt(score) + 1;
    } else if (e.target.className === "decrease" && score > 0) {
      score = score - 1;
    } else {
      return;
    }
    ...
    <>
      <div className={classes.container}>
        <div>
          ...
          {editing && (
            <form className={classes.form} onSubmit={editReplyHandler}>
        ...
        <div className={classes.bottom}>
          <div className={classes.scoreChanger}>
            <div onClick={editReplyScoreHandler} className="increase">
            ...
            <p>{props.score}</p>
            <div onClick={editReplyScoreHandler} className="decrease">
